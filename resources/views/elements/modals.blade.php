...
<div class="modal__window modal__window--bg modal__window--authorization" data-modal-type="authorization">
	<div class="modal__bg">
		<div class="col-left">
			<div class="image" style="background-image: url('{{ url('/public/img/content/modal-bg1.jpg') }}')"></div>
			<div class="modal-logo"><img src="{{ url('/public/img/content/logo.png') }}" alt="Autobox"></div>
		</div>
		<div class="col-right">
        ...
        <div class="modal__container">
        	<div class="modal__header-content">
				<div class="modal-header">
					<h3 class="title">{{ $_authmodals->text_10 }}</h3>
					...
					<div class="modal-body">
						<form class="form-style" autocomplete="off">
							<div class="fields-container">
								...
								<div class="fields-row fields-row--2 fields-row--captcha">
									<div class="col captcha-block">
										<img src="{{ url('/get_captcha') }}" class="captcha-view">
									</div>
							...
							<div class="form-footer">
								...
								<div class="two-cols">
									<div class="col-left">
										<button type="button" class="btn btn-red" onclick="__.register(event)">{{ $_authmodals->text_40 }}</button>
										<div class="message-container">
											<div class="message">{{ $_authmodals->text_41 }}</div>
										</div>
									</div>
									<div class="col-right">
										<div class="links"><a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="2">{{ $_authmodals->text_42 }}</a><span class="dash"></span>
											<a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="3">{{ $_authmodals->text_43 }}</a></div>
									</div>
								</div>
							</div>
	...
	<div class="modal__wrapper js_modal-part" data-modal-part="2">
		<div class="modal__container">
			<div class="modal__header-content">
				<div class="modal-header">
					<h3 class="title">{{ $_authmodals->text_1 }}</h3>
					<button class="btn-modal-close icon icon-cross3 js_modal-close"></button>
				</div>
			</div>
					...
					<div class="modal-body">
						<form class="form-style" id="auth-form" autocomplete="off">
							<div class="fields-container">
								...
								<div class="fields-row fields-row--2">
									<label class="col field-block">
										<span class="field-block__title">{{ $_authmodals->text_2 }}</span>
										<span class="field-block__input-container">
											<input type="text" name="login" style="display:none;">
											<input type="text" id="login" name="login" autocomplete="off">
											<span class="appearance"><span></span></span>
										</span>
										<span class="error-message">{{ $_authmodals->text_4 }}</span>
									</label>

									<label class="col field-block">
										<span class="field-block__title">{{ $_authmodals->text_3 }}</span>
										<span class="field-block__input-container">
											<input type="password" name="password" style="display:none;">
											<input type="password" id="password" name="password" autocomplete="off">
											<span class="appearance"><span></span></span>
										</span>
										<span class="error-message">{{ $_authmodals->text_5 }}</span>
									</label>
								</div>
							...
							<div class="form-footer">
								...
								<div class="two-cols">
									<div class="col-left">
										<button type="button" class="btn btn-red" onclick="__.auth(event)">{{ $_authmodals->text_6 }}</button>
										<div class="message-container">
											<div class="message">{{ $_authmodals->text_7 }}</div>
										</div>
									</div>
									<div class="col-right">
										<div class="links"><a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="1">{{ $_authmodals->text_8 }}</a><span class="dash"></span>
											<a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="3">{{ $_authmodals->text_9 }}</a></div>
									</div>
								</div>
							</div>
	...
	<div class="modal__wrapper js_modal-part" data-modal-part="3">
		<div class="modal__container">
			<div class="modal__header-content">
				<div class="modal-header">
					<h3 class="title">{{ $_authmodals->text_44 }}</h3>
					<button class="btn-modal-close icon icon-cross3 js_modal-close"></button>
				</div>
			</div>
					...
					<div class="modal-body">
						<form class="form-style">
							<div class="fields-container">
								...
								<div class="fields-row">
									<label class="col field-block">
										<span class="field-block__title">{{ $_authmodals->text_45 }}</span>
										<span class="field-block__input-container">
							...
							<div class="form-footer">
								<div class="two-cols">
									<div class="col-left">
										<button type="button" class="btn btn-red" onclick="__.recovery(event)">{{ $_authmodals->text_46 }}</button>
										<div class="message-container">
											<div class="message">{{ $_authmodals->text_47 }}</div>
										</div>
									</div>
									<div class="col-right">
										<div class="links"><a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="2">{{ $_authmodals->text_48 }}</a><span class="dash"></span>
											<a href="" class="js_modal-open" data-modal-type="authorization" data-modal-part="1">{{ $_authmodals->text_49 }}</a></div>
									</div>
								</div>
							</div>
...
<div class="modal__window modal__window--bg modal__window--authorization" data-modal-type="email-feedback">
	...
	<div class="modal__wrapper js_modal-part" data-modal-part="1">
		<div class="modal__container">
			<div class="modal__header-content">
				<div class="modal-header">
					<h3 class="title">{{ $_contactmodals->text_50 }}</h3>
					<button class="btn-modal-close icon icon-cross3 js_modal-close"></button>
				</div>
			</div>
					...
					<div class="modal-body">
						<form class="form-style">
							<div class="fields-container">
								...
								<div class="fields-row">
									<label class="col field-block">
										<span class="field-block__title">{{ $_contactmodals->text_51 }}</span>
										<span class="field-block__input-container">
											<input type="text" id="feedback-email" name="feedback-email" value="{{ SIGNEDIN ? $_user->email : '' }}">
											<span class="appearance"><span></span></span>
										</span>
									</label>
								</div>
								<div class="fields-row">
									<div class="col">
									    <label class="field-block field-block--textarea">
											...
											{{ $_contactmodals->text_52 }}<span class="field-block__title__star">*</span></span>
									        <span class="field-block__input-container">
							...
							<div class="form-footer">
								<div class="col-full">
									<button type="button" class="btn btn-red" onclick="__.emailFeedback(event)">{{ $_contactmodals->text_53 }}</button>
									<div class="message-container">
										<div class="message">{{ $_contactmodals->text_54 }}</div>
									</div>
								</div>
							</div>
