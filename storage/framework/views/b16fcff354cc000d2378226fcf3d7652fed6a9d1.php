                        ...
                        <table id="orders-table" class="table-style-black table-orders table-wide table-underline table-zebra js_table-tooltips js_dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <td class="cell-client-code"><?php echo e($_page->text_7); ?></td>
                                    <td class="cell-order"><?php echo e($_page->text_8); ?></td>
                                    <td class="cell-products"><?php echo e($_page->text_9); ?></td>
                                    <td class="cell-client"><?php echo e($_page->text_10); ?></td>
                                    <td class="cell-date"><?php echo e($_page->text_11); ?></td>
                                    <?php /* ?>
                                    <td class="cell-netto-price"><span class="price">{{ $_page->text_12 }}</span></td>
                                    <?php */ ?>
                            ...
                            <tbody>
                              <?php foreach($orders as $np => $order): ?>
                                <tr>
                                    ...
                                    <td class="cell-client-code" data-sort="<?php echo e($order->KundenCode); ?>">
                                        <div class="title-mobile"><span class="text"><?php echo e($_page->text_7); ?></span></div>
                                        <div class="cell-value"><?php echo e($order->KundenCode); ?></div>
                                    </td>
                                    ...
                                    <td class="cell-client" data-sort="<?php echo e($order->customer); ?>">
                                        <div class="title-mobile"><span class="text"><?php echo e($_page->text_10); ?></span></div>
                                        <div class="cell-value"><?php echo e($order->customer); ?></div>
                                    </td>
                                    ...
                                    <?php /* ?>
                                    <td class="cell-netto-price" data-sort="{{ sprintf('%.2f', $order->netto) }}">
