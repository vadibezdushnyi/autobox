          					...
          					<div class="modal-body">
          						<form class="form-style light" autocomplete="off">
          							...
          							<div class="form-footer">
          								...
          								<div class="two-cols">
          									<div class="col-left">
          										<button type="button" class="btn btn-red" onclick="__.signup(event)"><?php echo e($_authmodals->text_40); ?></button>
