...
<div class="page-header-bg animate page-header-bg--profile">
    ...
    <div class="page-wrapper">
        <div class="page-container">
            ...
            <div class="h-balance">
                <span class="h-balance__title">Your balance:</span>
                <span class="h-balance__price <?php echo e($_user->balance <= 0 ? 'negative' : ''); ?>"><?php echo e($_user->balance); ?>€</span>
                <span class="h-balance__title">Your debt:</span>
                <span class="h-balance__price <?php echo e($_user->balance <= 0 ? 'negative' : ''); ?>"><?php echo e($_user->debt); ?>€</span>     
            </div>
        </div>
    </div> 
</div>
