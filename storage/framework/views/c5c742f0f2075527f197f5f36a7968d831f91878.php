    ...
    <div class="page-wrapper">
        <div class="page-container">
            ...
            <div class="cart-container">
                ...
                <div class="cart-main" style="display:<?php echo e(empty($cart->products) ? 'none' : 'block'); ?>;">
                        ...
                        <div class="form-style form-style--dark strong-m">
                            <div class="form-footer">
                                <div class="form-message icon icon-attention message-error active">
                                    <?php echo $_page->text_24; ?> <br> <?php echo $_page->text_25; ?>: <strong class="price" id="claimed_to_refill"><?php echo e(number_format(($cart->ftotal - $_user->limit),2,',',' ')); ?> €</strong>
                                </div>
                                <?php if(false): ?>
                    ...
                    <div class="cart-footer-actions cart-footer-actions--ext">
                        <div class="total-amount">
                            <table>
                                <tbody><tr>
                                    <td><span class="text"><?php echo e($_page->text_27); ?></span></td>
                                    <td><span class="value total_amount"><?php echo e($cart->total); ?> €</span></td>
                                </tr>
                                <tr>
                                    <td><span class="text"><?php echo e($_page->text_28); ?></span></td>
                                    <td><span class="value total_vat"><?= $_settings->order_vat * 100 ?>%</span></td>
                                </tr>
                                <tr>
                                    <td><span class="text"><?php echo e($_page->text_29); ?></span></td>
                                    <td><span class="value total_vat_amount"><?php echo e($cart->vtotal); ?> €</span></td>
                                </tr>
                                <tr>
                                    <td><span class="text"><?php echo e($_page->text_30); ?></span></td>
                                    <td>
                                        <div class="field-block">
                                            <div class="field-block__input-container">
                                                <textarea placeholder="<?php echo e($_page->text_31); ?>" id="order_comment"></textarea>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="action-buttons">
                            ...
                            <button type="button" id="order_create_btn" class="btn btn-red-small <?php echo e(!$cart->can_order ? 'disabled' : ''); ?>" onclick="<?php echo e($cart->can_order ? '__.createOrder(event)' : ''); ?>">
                ...
                <div class="cart-empty-container emptiness" style="display:<?php echo e(empty($cart->products) ? 'block' : 'none'); ?>;">
