...
<title>Action LOAD DELETE REF FILE</title>
</head>

<body>
<?php 
	$query = "SELECT  * FROM [pre]files_ref WHERE `id`='".$_GET['id']."' ORDER BY id LIMIT 1";
	...
	$query = "DELETE FROM [pre]files_ref WHERE `id`='".$_GET['id']."' LIMIT 1";
