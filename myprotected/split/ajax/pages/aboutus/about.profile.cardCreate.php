<?php 
	...
	$cardItem = $zh->getCompanyProfileServicesItem($item_id);
	$rootPath = ROOT_PATH;
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"createAboutServiceBlock", 'ajaxFolder'=>'create', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>NEW SERVICE</h3>";
