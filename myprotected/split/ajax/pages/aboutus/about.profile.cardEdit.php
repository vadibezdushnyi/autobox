<?php 
	...
	$cardItem = $zh->getCompanyProfileServicesItem($item_id, $lpx);
	$rootPath = ROOT_PATH;
	...
	$cardTmp = array(
		...
		'Image'				=>	array( 'type'=>'header'),
	 	'File'				=>	array( 'type'=>'image_mono','field'=>'cover', 			'params'=>array( 'path'=>FILESROOT."/img/content/company-profile/", 'appTable'=>$appTable, 'id'=>$item_id ) ),
	 	'Image current'		=>	array( 'type'=>'hidden',	'field'=>'curr_filename', 	'params'=>array( 'field'=>"cover" ) ),
	 );

	$cardEditFormParams = array( 
		'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editAboutServiceBlock", 'ajaxFolder'=>'edit', 'appTable'=>$appTable 
	);
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>SERVICE #$item_id EDIT</h3>";
