<?php 
	...
	require_once "../../../library/allpages.class.php";
	
	$zh = new allpagesHelp($dbh);
	...
	// lpx - LANG PREFIX
	$lpx = (isset($params['lpx']) ? $params['lpx'] : ""); // empty = Israel
	
	$pageTable = "none"; // Page table
	
	$appTable = "projects_cats"; // Main table
