<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type'=>'privacy_h' );
	
	$data['headContent'] = $zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getPrivacy($params);

	$totalItems = $zh->getPrivacy($params,true);
	...
	$filter1_options = array( 'By ID'=>'M.id', 'By Name'=>'M.q' );
	...
	$tableColumns = array(
						  ...
						  'Заголовок'				=>	array('type'=>'text',		'field'=>'q'),
						  'Описание'				=>	array('type'=>'text',		'field'=>'a'),
						  'Публикация'			=>	array('type'=>'block',		'field'=>'block'),
						  'Порядковый номер'					=>	array('type'=>'text',		'field'=>'order_id'),
