<?php 
	...
	$cardTmp = array(
		...
		'Related posts'					=>	array( 'type'=>'select_multiple', 	'field'=>'posts', 		'params'=>array( 
																											'selected'=>$cardItem['posts'],
																											'elements'=>$posts, 
																											'name_key'=>'name', 
					 																						'value_key'=>'id', 
					 																						'selected_key'=>'id', 
	...
	$cardEditFormParams = array( 
		'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editArticleTags", 'ajaxFolder'=>'edit', 
		'appTable'=>$appTable,
	);
