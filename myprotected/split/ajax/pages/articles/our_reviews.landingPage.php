<?php 
	...
	$totalItems = $zh->getReviews($params,true);
	...
	$tableColumns = array(
						  ...
						  'Название'			=>	array('type'=>'text',		'field'=>'company_name'),
						  'Отзыв'				=>	array('type'=>'text',		'field'=>'text'),
						  'Публикация'			=>	array('type'=>'block',		'field'=>'block' , 'params'=>['reverse'=>true]),
