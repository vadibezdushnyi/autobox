<?php 
	...
	$itemsList = $zh->getArticles($params);

	$totalItems = $zh->getArticles($params,true);
	...
	$tableColumns = array(
						  ...
						  'Post title'			=>	array('type'=>'text',		'field'=>'name'),
						  'Category'			=>	array('type'=>'text',		'field'=>'cat_name'),
						  'Publication'			=>	array('type'=>'block',		'field'=>'block'),
						  'View'				=>	array('type'=>'cardView',	'field'=>'Смотреть' , 'lpx'=>true),
						  'Edit'				=>	array('type'=>'cardEdit',	'field'=>'Редактировать', 'lpx'=>true),
