<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type'=>'' ); // categMatHeader
	
	$data['headContent'] = $zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getArtCategories($params);

	$totalItems = $zh->getArtCategories($params,true);
	...
	$tableColumns = array(
						  ...
						  'Posts amount'		=>	array('type'=>'text',		'field'=>'arts_quant'),
						  'View'				=>	array('type'=>'cardView',	'field'=>'view mode'),
						  'Edit'				=>	array('type'=>'cardEdit',	'field'=>'edit mode'),
