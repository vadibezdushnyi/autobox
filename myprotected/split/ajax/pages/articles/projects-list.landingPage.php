<?php 
	...
	$itemsList = $zh->getProjectsList($params);
	$totalItems = $zh->getProjectsList($params,true);
	...
	$tableColumns = [
		...
		'Проект'			=>	['type'=>'text',		'field'=>'name'],
		'Бюджет'			=>	['type'=>'money',		'field'=>'budget'],
		'Откликов'			=>	['type'=>'money',		'field'=>'responses'],
	  ...
	  'Модерация'			=>	['type'=>'text',		'field'=>'moderation',                           									
														'params'=>[
          													...
          													'data'=>['0'=>'Нет','1'=>'Да'],
          													'active'=>'moderation',
          													'clickFunction'=>'ProjectModUpdate'
      													]],
