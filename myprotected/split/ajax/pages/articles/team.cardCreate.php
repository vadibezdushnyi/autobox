<?php 
	...
	$cardItem = $zh->getTeamItem($item_id);
	...
	$cardTmp = array(
		...
		'Name'		=>	array( 'type'=>'input', 	'field'=>'name', 		'params'=>array( 'size'=>100, 'hold'=>'full name' ) ),
		'Position'	=>	array( 'type'=>'input', 	'field'=>'position', 	'params'=>array( 'size'=>100, 'hold'=>'current position' ) ),
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"createTeamMember", 'ajaxFolder'=>'create', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>NEW TEAM MEMBER</h3>";
