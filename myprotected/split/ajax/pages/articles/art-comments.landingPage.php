<?php 
	...
	$itemsList = $zh->getArticleComments($params);

	$totalItems = $zh->getArticleComments($params,true);
	...
	$filter1_options = array( 'По ID'=>'M.id', 'По названии'=>'M.name' );
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name', 'Публикации'=>'block' ),
	...
	$tableColumns = array(
						  ...
						  'Статья'				=>	array('type'=>'text',		'field'=>'prod_name'),
						  'Имя'					=>	array('type'=>'text',		'field'=>'name'),
						  'Комментарий'			=>	array('type'=>'text',		'field'=>'comment'),
