<?php 
	...
	$itemsList = $zh->getTeam($params);

	$totalItems = $zh->getTeam($params,true);
	...
	$tableColumns = array(
		...
		'Position'			=>	array('type'=>'text',		'field'=>'position'),
		'Publication'		=>	array('type'=>'block',		'field'=>'block'),
		'Support'			=>	array('type'=>'block',		'field'=>'support', 'params'=>array('reverse'=>true)),
		'Display number'	=>	array('type'=>'text',		'field'=>'order_id'),
