<?php 
	...
	$itemsList = $zh->getProblemsList($params);
	$totalItems = $zh->getProblemsList($params,true);
	...
	$tableColumns = [
		...
		'Проблема'			=>	['type'=>'text',		'field'=>'name'],
		'Дедлайн'			=>	['type'=>'datetime',		'field'=>'deadline'],
		'Решений'			=>	['type'=>'money',		'field'=>'solutions'],
		'Статус'			=>	['type'=>'text',		'field'=>'status_name'],
		...
		'Редактирование'	=>	['type'=>'cardEdit',	'field'=>'Редактировать', 'lpx'=>true],
	  	'Модерация'			=>	['type'=>'text',		'field'=>'moderation',                           									
														'params'=>[
          													...
          													'data'=>['0'=>'Нет','1'=>'Да'],
          													'active'=>'moderation',
          													'clickFunction'=>'ProblemModUpdate'
      													]],
