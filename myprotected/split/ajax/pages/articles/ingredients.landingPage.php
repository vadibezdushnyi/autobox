<?php 
	...
	$itemsList = $zh->getIngredients($params);

	$totalItems = $zh->getIngredients($params,true);
	...
	$tableColumns = array(
						  ...
						  'Изображение'			=>	['type'=>'image',		'field'=>'image','params'=>['path'=>'/delice.cake/img/content/']],
						  'Тип'					=>	array('type'=>'text',		'field'=>'type'),
						  'Направление'			=>	array('type'=>'text',		'field'=>'category'),
						  'Название'			=>	array('type'=>'text',		'field'=>'name'),
						  'Назначение'			=>	array('type'=>'text',		'field'=>'title'),
