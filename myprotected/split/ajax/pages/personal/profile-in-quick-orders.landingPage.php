<?php 
	...
	$headParams = array( 'parent'=>$parent, 'alias'=>$alias, 'id'=>$id, 'appTable'=>$appTable, 'type'=>'in-quick-orders' );
	
	$data['headContent'] = "";//$zh->getLandingHeader($headParams);
	
	// Get page items
	
	$itemsList = $zh->getQuickOrders($params);

	$totalItems = $zh->getQuickOrders($params,true);
	...
	$tableColumns = array(
						  ...
						  'Клиент'				=>	array('type'=>'text',		'field'=>'user_name', 		'params'=>array( 'secondField'=>'user_name', 'separate'=>" " ) ),
						  'Телефон'				=>	array('type'=>'text',		'field'=>'user_phone'),
						  'Создан'				=>	array('type'=>'date',		'field'=>'dateCreate', 		'params'=>array( 'format'=>'d-m-Y') ),
						  'Просмотр'			=>	array('type'=>'cardView',	'field'=>'Смотреть',		'params'=>array( 'type'=>'quickOrderViewTask' ) )
						  );
