<?php 
	...
	require_once "../../../library/personal.class.php";
	
	$zh = new personalHelp($dbh);
	...
	$appTable = "income_questions"; // Main table

	if( $actionType == 'cardView' ){
		$zh->setViewedStatus($item_id, $appTable);
	}
