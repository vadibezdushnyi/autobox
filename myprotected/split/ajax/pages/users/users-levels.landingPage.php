<?php 
	...
	$itemsList = $zh->getAllUsersTypes($params);

	$totalItems = $zh->getAllUsersTypes($params,true);
	...
	$tableColumns = array(
						  ...
						  'Group name'			=>	array('type'=>'text',		'field'=>'name'),
						  'Alias'				=>	array('type'=>'text',		'field'=>'alias'),
						  'Publish'				=>	array('type'=>'block',		'field'=>'block'),
						  'Users in'			=>	array('type'=>'text',		'field'=>'users_quant'),
