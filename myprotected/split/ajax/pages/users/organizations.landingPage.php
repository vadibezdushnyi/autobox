<?php 
	...
	$itemsList = $zh->getAllOrganizations($params);

	$totalItems = $zh->getAllOrganizations($params,true);
	...
	$tableColumns = array(
						  ...
						  'Аватар'			=>	['type'=>'image',		'field'=>'image','params'=>['path'=>'/platform/img/avatars/']],
						  'Название'		=>	array('type'=>'text',		'field'=>'org_name'),
						  'Специализация'	=>	array('type'=>'text',		'field'=>'spec'),
						  'Контактно лицо'	=>	array('type'=>'text',		'field'=>'contact_name'),
						  'Телефон'			=>	array('type'=>'text',		'field'=>'phone'),
						  'Дата регистрации'=>	array('type'=>'datetime',		'field'=>'created'),
						  'Просмотр'		=>	array('type'=>'cardView',	'field'=>'Смотреть'),
						  'Редактирование'	=>	array('type'=>'cardEdit',	'field'=>'Редактировать'),
						  'Активен'			=>	array('type'=>'block',	'field'=>'confirmed', 'params'=>['reverse'=>true]),
  						   'Блокировка'			=>	['type'=>'text',		'field'=>'block',                           									
							'params'=>[
									'type'=>'ajaxColumn',
									'alias'=>'Ostatus',
									'form'=>'trigger',
									'data'=>['0'=>'Нет','1'=>'Да'],
									'active'=>'block',
									'clickFunction'=>'OrgBlockUpdate'
								]],
						  	'Подтверждение'			=>	['type'=>'text',		'field'=>'agreed',                           									
							'params'=>[
									'type'=>'ajaxColumn',
									'alias'=>'Ostatus',
									'form'=>'trigger',
