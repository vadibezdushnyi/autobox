<?php 
	...
	$itemsList = $zh->getAllGlobalSettings($params);

	$totalItems = $zh->getCountGlobalSettings($params);
	...
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name', 'Parent'=>'parent' ),
	...
	$tableColumns = array(
						  ...
						  'Parent'		=>	array('type'=>'parent',		'field'=>'parent_name'),
