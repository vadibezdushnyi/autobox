<?php 
	...
	$itemsList = $zh->getBanners($params);

	$totalItems = $zh->getBanners($params,true);
	...
	$filter2_options = array( 
							'Publication'	=> array( 'fieldName'=>'M.block', 'params' => array('Yes'=>'0', 'No'=>'1') )
							);
							
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name' ),
							'order' => array( 'Ascending'=>'', 'Descending'=>' DESC' ) 
							);
	// Start data content
	...
	$tableColumns = array(
						  ...
						  'Position'				=>	array('type'=>'text',		'field'=>'order_id'),
						  'View'			=>	array('type'=>'cardView',	'field'=>'Смотреть', 'lpx'=>true),
						  'Editing'		=>	array('type'=>'cardEdit',	'field'=>'Редактировать', 'lpx'=>true),
